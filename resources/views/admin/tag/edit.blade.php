    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-header-title">
                <h4 class="pull-left page-title">Edit Tag</h4>
                        ...
                        <div class="col-xs-12">
                            <form role="form" action="{{route('admin.tags.update', $tag->id)}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{$tag->name ? $tag->name : old('name') }}" class="form-control @error('name') is-invalid @enderror" id="ex1" placeholder="Enter tag name">
                                </div>
                                @error('name')
