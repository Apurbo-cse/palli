        ...
        <div class="panel panel-color panel-primary panel-pages">
            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal m-t-20" action="{{route('register')}}" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input value="{{ old('phone') }}" class="form-control @error('phone') is-invalid @enderror" name="phone" type="text" required="" placeholder="Enter Your phone">
                        </div>
                    </div>
                    @error('phone')
                    <div class="alert alert-danger">{{ $message }}</div>
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input type="password" name="password_confirmation" id="confirmPassword" class="form-control" placeholder="Confirm Password" autocomplete="new-password">
                        </div>
                    </div>
                    @error('password')
                    <div class="alert alert-danger">{{ $message }}</div>
