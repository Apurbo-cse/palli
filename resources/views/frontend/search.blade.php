...
@section('title', 'Palli Crafts || SEARCH RESULT')
@push('css')
    <style>
        .pagination{
            display:inline-flex;
                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Search result</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <div class="shop-top">
                                <div class="shop-shorter">
                                    <div class="single-shorter">
                                        <p>Total search result <span class="search__result">{{count($products)}}</span></p>
                                    </div>
                                </div>
                            </div>
                            <!--/ End Shop Top -->
